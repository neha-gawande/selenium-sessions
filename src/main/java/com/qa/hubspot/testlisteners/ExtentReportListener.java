...
public class ExtentReportListener extends BasePage implements ITestListener{
	...
	private static final String FILE_NAME = "TestExecutionReports.html";
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			...
			System.err
			         .println("Exception thown while updating test fail status" + Arrays.toString(e.getStackTrace()));
		}
		test.get().getModel().setEndTime(getTime(result.getEndMillis()));
	}
