...
public class TesultsListener extends BasePage implements ITestListener {
	...
	public void onFinish(ITestContext iTestContext) {
		...
		data.put("target","eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6Ijk5Y2Y3OTczLTk0YjctNDU5Ny1iYWEzLTA"
				+ "yYjkzYTNhZjVkZi0xNTk3MzkyNzYyMTg3IiwiZXhwIjo0MTAyNDQ0ODAwMDAwLCJ2ZXIiOiIwIiwic2VzIjoiNTQ2"
				+ "ZGNiZTQtMmMzOC00MjFiLThkZjItYThjYjFmMGVhM2NhIiwidHlwZSI6InQifQ.S2vZuaSbMaPULwpCYxttV1KQmUUiBZZ7yy6ClvhtxBk");
